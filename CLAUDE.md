...
**v1.0.9** — em produção desde 2026-06-12.
...
- **Versão:** v1.0.9 — **em produção** desde 2026-06-12 (primeira unidade: Caucaia). Branch `master`. Implantação em 4 unidades prevista para hoje (2026-08-04).
